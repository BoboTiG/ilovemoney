...
from ilovemoney.monkeypath_continuum import PatchedTransactionFactory
from ilovemoney.utils import generate_password_hash, get_members, same_bill
from ilovemoney.versioning import (
...
class Project(db.Model):
    ...
    def remove_project(self):
        ...
        from ilovemoney.history import purge_history
