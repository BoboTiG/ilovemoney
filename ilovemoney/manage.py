...
from ilovemoney.models import Project, db
from ilovemoney.run import create_app
from ilovemoney.utils import create_jinja_env, generate_password_hash


@click.group(cls=FlaskGroup, create_app=create_app)
def cli():
    """ILoveMoney Management script"""
