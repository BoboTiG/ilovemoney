...
from ilovemoney.tests.common.help_functions import extract_link
from ilovemoney.tests.common.ilovemoney_testcase import IlovemoneyTestCase
from ilovemoney.utils import generate_password_hash
from ilovemoney.versioning import LoggingMode
from ilovemoney.web import build_etag


class TestBudget(IlovemoneyTestCase):
    ...
    def test_login_throttler(self):
        ...
        from ilovemoney.utils import limiter
    ...
    def test_session_projects_migration_to_list(self):
        """In https://github.com/BoboTiG/ilovemoney/pull/1082, session["projects"]
...
<rss version="2.0"
    ...
    >
    <channel>
        <title>I Love Money — raclette</title>
